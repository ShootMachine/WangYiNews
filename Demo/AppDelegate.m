...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NEWSMainViewController *Main = [[NEWSMainViewController alloc]init];
     BaseNavigationController *nav = [[BaseNavigationController alloc]initWithRootViewController:Main];
    
    
    LeftViewController *v = [[LeftViewController alloc]init];
    v.view.backgroundColor = [UIColor whiteColor];

    _sideMenuViewController = [[RESideMenu alloc] initWithContentViewController:nav
                                                         leftMenuViewController:v
...
//    _sideMenuViewController.contentViewShadowColor = MRQGlobalBg;
